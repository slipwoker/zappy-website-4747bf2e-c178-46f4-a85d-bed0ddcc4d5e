document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const existingError = parent ? parent.querySelector('.error-message') : null;
      if (existingError) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.querySelector('.form-success, .success-message');
      if (successMessage) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
      ...
      "es": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) utiliza cookies para mejorar tu experiencia, analizar el uso del sitio y ayudar en nuestros esfuerzos de marketing.",
      ...
      "fr": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) utilise des cookies pour améliorer votre expérience, analyser l'utilisation du site et nous aider dans nos efforts marketing.",
      ...
      "de": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) verwendet Cookies, um Ihr Erlebnis zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingbemühungen zu unterstützen.",
      ...
      "it": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) utilizza i cookie per migliorare la tua esperienza, analizzare l'utilizzo del sito e supportare le nostre attività di marketing.",
      ...
      "pt": {
        "consentModal": {
          "title": "Usamos cookies 🍪",
          "description": "של סבתא (Grandma's Jewelry) usa cookies para melhorar sua experiência, analisar o uso do site e auxiliar em nossos esforços de marketing.",
      ...
      "nl": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) gebruikt cookies om uw ervaring te verbeteren, het sitegebruik te analyseren en onze marketinginspanningen te ondersteunen.",
      ...
      "he": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
      ...
      "ar": {
        "consentModal": {
          ...
          "description": "يستخدم של סבתא (Grandma's Jewelry) ملفات تعريف الارتباط لتحسين تجربتك وتحليل استخدام الموقع والمساعدة في جهودنا التسويقية.",
      ...
      "tr": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry), deneyiminizi geliştirmek, site kullanımını analiz etmek ve pazarlama çalışmalarımıza yardımcı olmak için çerezler kullanır.",
      ...
      "ru": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) использует файлы cookie для улучшения вашего опыта, анализа использования сайта и поддержки наших маркетинговых усилий.",
      ...
      "zh": {
        "consentModal": {
          "title": "我们使用 Cookie 🍪",
          "description": "של סבתא (Grandma's Jewelry) 使用 Cookie 来改善您的体验、分析网站使用情况并协助我们的营销工作。",
          "acceptAllBtn": "全部接受",
      ...
      "ja": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry)は、お客様の体験向上、サイト利用状況の分析、マーケティング活動の支援のためにCookieを使用しています。",
          "acceptAllBtn": "すべて許可",
      ...
      "ko": {
        "consentModal": {
          "title": "쿠키를 사용합니다 🍪",
          "description": "של סבתא (Grandma's Jewelry)은(는) 경험 향상, 사이트 사용 분석 및 마케팅 활동 지원을 위해 쿠키를 사용합니다.",
          "acceptAllBtn": "모두 수락",
      ...
      "pl": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) używa plików cookie, aby poprawić Twoje wrażenia, analizować korzystanie z witryny i wspierać nasze działania marketingowe.",
      ...
      "uk": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) використовує файли cookie для покращення вашого досвіду, аналізу використання сайту та підтримки наших маркетингових зусиль.",
      ...
      "ro": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) folosește cookie-uri pentru a vă îmbunătăți experiența, a analiza utilizarea site-ului și a sprijini eforturile noastre de marketing.",
      ...
      "bg": {
        "consentModal": {
          ...
          "description": "של סבתא (Grandma's Jewelry) използва бисквитки, за да подобри вашето изживяване, да анализира използването на сайта и да подпомогне маркетинговите ни усилия.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4747bf2e-c178-46f4-a85d-bed0ddcc4d5e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4747bf2e-c178-46f4-a85d-bed0ddcc4d5e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4747bf2e-c178-46f4-a85d-bed0ddcc4d5e';
